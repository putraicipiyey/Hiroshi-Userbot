...
from userbot.utils import edit_delete, edit_or_reply, get_user_from_event, hiro_cmd


@hiro_cmd(pattern="userid$")
...
CMD_HELP.update(
    {
        ...
        \n  •  **Contoh : **{cmd}link @Bisubiarenak Ganteng\
    "
    }
)
