...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "Heroku Connecting To Latest Github Build (UserbotMaps/Hiroshi-Userbot)",
        ...
        "INFO - Hiroshi-Userbot: Logged in as 557667062",
        "INFO - Hiroshi-Userbot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Hiroshi-Userbot -",
        "INFO -  ✨Hiroshi-Userbot✨  ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
