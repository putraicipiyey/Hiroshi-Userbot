...
import psutil
from userbot import ALIVE_LOGO, ALIVE_NAME, BOT_VER, CMD_HELP, HIRO_TEKS_KUSTOM, StartTime, UPSTREAM_REPO_BRANCH, bot
...
@register(outgoing=True, pattern=r"^\.(?:hiroalive)\s?(.)?")
