...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC") or "https://telegra.ph/file/976476c736daf4c588014.jpg"
...
HIRO_TEKS_KUSTOM = os.environ.get("HIRO_TEKS_KUSTOM", "")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Hiroshi-Userbot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/91ccbe90ffe7f7c5107e5.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/91ccbe90ffe7f7c5107e5.jpg"
...
async def check_alive():
    await bot.send_file(BOTLOG_CHATID, ALIVE_LOGO, caption=f"**ʜɪʀɪsʜɪ-ᴜsᴇʀʙᴏᴛ ʙᴇʀʜᴀsɪʟ ᴅɪᴀᴋᴛɪғᴋᴀɴ✨**\n━━━━━━━━━━━━━━━━━━━\n❃ **ʙᴏᴛ ᴏꜰ :** {ALIVE_NAME}\n❃ **ʙᴏᴛ ᴠᴇʀ :** 7.0\n━━━━━━━━━━━━━━━━━━━\n❃ **sᴜᴘᴘᴏʀᴛ​ :** @NastySupportt\n❃ **ᴄʜᴀɴɴᴇʟ​ :** @NastyProject \n━━━━━━━━━━━━━━━━━━━")
    return
        ...
        async def opeen(event):
            try:
                ...
                if tgbotusername is not None:
                    results = await event.client.inline_query(tgbotusername, "@Hiroshimarobot")
...
# ====================================InlineHandler===================================== #
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    f"❁ __Saya Adalah Hiroshi Userbot Yang Digunakan Banyak User Telegram__.\n\n"
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× `.alive` × `.Hiroshialive` × `.Hiroshion`\n"
                    f"°__Menampilkan Alive Punya Kamu__.\n\n"
                    f"× `.set var ALIVE_LOGO` [**LINK**]\n"
                    f"°__Mengubah Foto Alive Kamu, Yang Kamu Inginkan__.\n\n"
                    f"× `.set var HIROSHI_TEKS_KUSTOM` [**TEKS**]\n"
                    f"°__Mengganti Teks Yang Ada Command HiroshiAlive__.\n\n"
                    f"© @Bisubiarenak")
                await event.edit(
                    text,
                    file=kyylogo,
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× **Pembaruan Data Untuk Hiroshi Userbot, Command Untuk Pembaruan**.\n"
                    f"⚒Pembaruan Data :\n"
                    f"`.update deploy`\n"
                    f"`update`\n\n"
                    f"© @Bisubiarenak")
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    ...
                    buttons=[
                        ...
                        [custom.Button.url(
                            "License",
                            "https://github.com/UserbotMaps/Hiroshi-Userbot/LICENSE")],
                    ],
                    link_preview=False,
                )
